//
//
//object SimpleApp extends Application {
//
//  // Should work out of the box. If you already have the data, it should be more or less a
//  // one-liner to render it.
////  class ChartingWindow {
////    val JFreeChart = ChartFactory.createTimeSeriesChart("International Coffee Organisation : Coffee Prices", null, "US Lib", ???)
////  }
//
//
...
//
//
//  private def createChart(dataset: Nothing) = {
//    val chart = ChartFactory.createTimeSeriesChart("International Coffee Organisation : Coffee Prices", // title
//      null, // x-axis label
//      "US cents/lb", // y-axis label
//      dataset)
//    val fontName = "Palatino"
//    chart.getTitle.setFont(new Font(fontName, Font.BOLD, 18))
//    chart.addSubtitle(new Nothing("Source: http://www.ico.org/historical/2010-19/PDF/HIST-PRICES.pdf", new Font(fontName, Font.PLAIN, 14)))
//    val plot = chart.getPlot.asInstanceOf[Nothing]
...
//    if (r.isInstanceOf[Nothing]) {
//      val renderer = r.asInstanceOf[Nothing]
//      renderer.setDefaultShapesVisible(false)
//      renderer.setDrawSeriesLineAsPath(true)
//      // set the default stroke for all series
//      renderer.setAutoPopulateSeriesStroke(false)
//      renderer.setDefaultStroke(new Nothing(3.0f))
//      renderer.setSeriesPaint(0, Color.RED)
//      renderer.setSeriesPaint(1, new Nothing(24, 123, 58))
//      renderer.setSeriesPaint(2, new Nothing(149, 201, 136))
//      renderer.setSeriesPaint(3, new Nothing(1, 62, 29))
//      renderer.setSeriesPaint(4, new Nothing(81, 176, 86))
//      renderer.setSeriesPaint(5, new Nothing(0, 55, 122))
//      renderer.setSeriesPaint(6, new Nothing(0, 92, 165))
//    }
//    chart
//  }
//
...
//
//      val s1: TimeSeries = new TimeSeries("Indicator Price")
//
...
//
//        val s2: TimeSeries = new TimeSeries("Columbian Milds");
...
//
//        val s3: TimeSeries = new TimeSeries("Other Milds");
...
//
//        val s4: TimeSeries = new TimeSeries("Brazilian Naturals");
...
//
//        val s5: TimeSeries = new TimeSeries("Robustas");
...
//
//        val s6: TimeSeries = new TimeSeries("Futures (London)");
...
//
//      val s7: TimeSeries = new TimeSeries("Futures (New York)");
